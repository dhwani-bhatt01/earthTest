...
import baseDexImg from './assets/images/baseDex.svg';
...
function Home() {
  ...
  const parentStrategyValContractExplorer = "https://mainnet.opbnbscan.com/address/0x46ECf770a99d5d81056243deA22ecaB7271a43C7";
  const parentStrategyValContract = "0x46ECf770a99d5d81056243deA22ecaB7271a43C7";
  const staticValutList = ["0xAbaf80156857E05b1EB162552Bea517b25F29aD9", "0xA7B88e482d3C9d17A1b83bc3FbeB4DF72cB20478"];
    ...
    return (
      <>
        <div className='dsp mb-4'>
          ...
          <div><img src={rocketAccordianImg} alt="Icon" style={{ marginRight: '10px', width: '28px' }} />  <span className='mr_10'>3 September 2023 | 14:35:00 UTC</span><img src={externalLinkGreenImg} alt='externalLink' /></div>
          <div><img src={flagGreenImg} alt="Icon" style={{ marginRight: '10px', width: '28px' }} />  <span className='mr_10'>3 September 2023 | 14:37:00 UTC</span> <img src={externalLinkGreenImg} alt='externalLink' /></div>
        </div>
        <div className='dsp'>
          <div> <div className='fnt_wght_500 mb-2'>Starting Balance</div> <div>12.32657812 WBNB-0101 LP</div></div>
          <div> <div className='fnt_wght_500 mb-2'>Ending Balance </div>  <div>12.33567612 WBNB-0101 LP</div> </div>
          <div> <div className='fnt_wght_500 mb-2'>Epoch Growth</div>  <div className='primary_header_color'>8%</div></div>
          <div> <div className='fnt_wght_500 mb-2'>Epoch APR</div>  <div className='primary_header_color'>7200%</div></div>
  ...
  const CustomAccordianHeader2: React.FC<CustomTabHeaderProps> = ({ icon, title }) => {
    return (
      <>
        <div className='dsp mb-4'>
          <div> {icon && <img src={icon} alt="Icon" style={{ marginRight: '10px', width: '28px' }} />}  <span className='primary_header_color'>{title}</span> </div>
          <div><img src={rocketAccordianImg} alt="Icon" style={{ marginRight: '10px', width: '28px' }} />  <span className='mr_10'>2 September 2023 | 22:30:00 UTC</span><img src={externalLinkGreenImg} alt='externalLink' /></div>
          <div><img src={flagGreenImg} alt="Icon" style={{ marginRight: '10px', width: '28px' }} />  <span className='mr_10'>3 September 2023 | 1:30:00 UTC</span> <img src={externalLinkGreenImg} alt='externalLink' /></div>
        </div>
        <div className='dsp'>
          <div> <div className='fnt_wght_500 mb-2'>Starting Balance</div> <div>20.03301761 WBNB-0101 LP</div></div>
          <div> <div className='fnt_wght_500 mb-2'>Ending Balance </div>  <div>21.03301761 WBNB-0101 LP</div> </div>
          <div> <div className='fnt_wght_500 mb-2'>Epoch Growth</div>  <div className='primary_header_color'>8%</div></div>
          <div> <div className='fnt_wght_500 mb-2'>Epoch APR</div>  <div className='primary_header_color'>7200%</div></div>
            ...
            <div className='dsp_cont'>
              ...
              <div>
                <span className='ml_12 opct_61'>DEX</span>
                 <br />
                <img src={binarySwapImg} alt='chain' className='wdth_80px' />
              </div>
              ...
              <span className='opct_61'>Pool TVL</span>
                 <br /> <span className='primary_header_color fnt_wgt_600'>$0.3M</span>
              </div>
              <div>
              <span className='opct_61'>Pool APR</span>
                <br /> <span className='primary_header_color fnt_wgt_600'>2365%</span>
              </div>
            </div>
          </div>
          ...
          {epochRunning ?
            <>
              <div className='second_section outer_section_first mb-4'>
                ...
                <div className='dsp'>
                  <div> <div>Strategy LP Balance</div> <div className='fnt_wgt_600'>{startingBalance} WBNB-0101 LP  </div></div>
                  <div> <div>Overall Gain</div>  <div className='fnt_wgt_600'>0.00 WBNB-0101 LP</div> </div>
                  <div> <div>Overall Return</div>  <div className='fnt_wgt_600 primary_header_color'>1.02%</div></div>
                  <div> <div>Current APR</div>  <div className='fnt_wgt_600 primary_header_color'>2400%</div></div>
              ...
              {lpValutList.map((e: any, index: any) => {
                return <div key={index}>
                  <div className='first_section outer_section_red'>
                    {/* <div className="small-home-div-3"></div> */}
                    <div className='dsp'>
                      <div className='header_font_size'><span><img src={wbnbImg} alt='btc img' className='btc_img_width' /><img src={oioiImg} alt='btc img' className='btc_img_width ml_20_neg' /></span>{e.name}  <img src={externalLinkRedImg} onClick={() => { goToUrl(e.contractExplorer) }} alt='externalLink' className='crsr_pntr' /></div>
                      <div>
                      <span className='mr_15 opct_61'>Overall APR </span> <span className='firstRedBox'>6954%</span>
                      </div>
                    ...
                    <div className='redBox mb-3'>
                      ...
                      <div className='dsp'>
                        <div><span className='opct_61'>Projected APR</span> <br /> <span className='fnt_wgt_600'> 6954% </span><span className='base_fnt'>Based on Current Pool APR</span></div>
                        <div></div>
                      </div>
                    </div>
          ...
          <div className='m10 mb-5'>
            ...
            <AccordionTab header={<CustomAccordianHeader1 icon={epochImg} title="Epoch was live for 2 minutes" />}>
                <div className='dsp wdth_100'>
                  <div> <div>Collateral Deposited</div> <div>5.23 WBNB-0101 LP  </div></div>
                  <div> <div>Overall  Return</div>  <div>0.34 WBNB-0101 LP</div> </div>
                  <div> <div>Net Growth</div>  <div>8%</div></div>
                  <div> <div>Net APR</div>  <div>7200%</div></div>
                  <div> <div>Leverage</div>  <div>3.3x</div></div>
                </div>
                <hr />
                <div className='dsp wdth_100'>
                  <div> <div>Borrowed Liquidity</div> <div>80.23 WBNB <br/>180,000 0101   </div></div>
                  <div> <div>Overall  Return</div>  <div>0.56 WBNB<br/>1,092 0101</div> </div>
                  <div> <div>Net Growth</div>  <div>1 %<br/>2 %</div></div>
                  <div> <div>Net APR</div>  <div>52 %<br/>104 %</div></div>
              ...
              <AccordionTab header={<CustomAccordianHeader2 icon={epochImg} title="Epoch was live for 8 hours" />}>
                <div className='dsp wdth_100'>
                  <div> <div>Collateral Deposited</div> <div>7.23 WBNB-0101 LP  </div></div>
                  <div> <div>Overall  Return</div>  <div>0.34 WBNB-0101 LP</div> </div>
                  <div> <div>Net Growth</div>  <div>8%</div></div>
                  <div> <div>Net APR</div>  <div>7200%</div></div>
                  <div> <div>Leverage</div>  <div>3.3x</div></div>
                ...
                <hr />
                <div className='dsp wdth_100'>
                  <div> <div>Borrowed Liquidity</div> <div>100.23 WBNB <br/>200,000 0101   </div></div>
                  <div> <div>Overall  Return</div>  <div>0.56 WBNB<br/>1,092 0101</div> </div>
                  <div> <div>Net Growth</div>  <div>1 %<br/>2 %</div></div>
                  <div> <div>Net APR</div>  <div>52 %<br/>104 %</div></div>
                  <div className='wdth4'> <div></div>  <div></div></div>
                ...
                <div className='mt-3 text-center'>
                  ...
                  {isConnected ?
                    (chain as any)?.id !== Number("204") ?
                      <button className='btn btn-riv-primary wdth_100' onClick={() => { networkSwitchHandler(Number("204")) }} >Switch to OP BNB</button>
                      : isApproved ? <button className='btn btn-riv-primary wdth_100' onClick={deposit} disabled={isTransactionOnGoing}> Deposit</button>
                        : <button className='btn btn-riv-primary wdth_100' onClick={approveIntilize} disabled={isTransactionOnGoing}>Approve</button> :
                    <>
                      <div className='d-flex justify-content-center'><ConnectButton /></div>
